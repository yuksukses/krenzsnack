...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['middleware' => 'level:admin'], function () {
        ...
        Route::post('/member/cetak-member', [MemberController::class, 'cetakMember'])->name('member.cetak_kartu');
    ...
    Route::group(['middleware' => 'level:admin,kasir'], function () {
        ...
        Route::get('{id_penjualan}/transaksi/selesai', [PenjualanController::class, 'selesai'])->name('transaksi.selesai');
        Route::get('{id_penjualan}/transaksi/nota-kecil', [PenjualanController::class, 'notaKecil'])->name('transaksi.nota_kecil');
