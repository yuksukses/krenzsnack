...
<div class="ibox float-e-margins">
    <div class="ibox-title">
        <button onclick="addForm('{{ route('pengeluaran.store') }}')" class="btn btn-success btn-outline btn-xs dim"><i
                class="fa fa-plus"></i>
            Tambah</button>
    </div>
...
<script>
    ...
    function editForm(url){
        ...
        .done((response) => {
            ...
            $('#modal-form [name=kode_transaksi]').val(response.kode_transaksi);
