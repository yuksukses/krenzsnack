            ...
            <div class="modal-content animated fadeIn">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <select name="id_deskripsi_pengeluaran" id="id_deskripsi_pengeluaran" class="form-control" required>
                                <option value="">Pilih Salah Satu</option>
                         @foreach ($deskripsi as $key=>$item)
                            <option value="{{$item->id_deskripsi_pengeluaran}}">{{$item->kode_transaksi}} || {{$item->deskripsi_pengeluaran}}</option>
                        @endforeach
